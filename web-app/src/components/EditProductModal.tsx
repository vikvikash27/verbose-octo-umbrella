...
const EditProductModal: React.FC<EditProductModalProps> = ({
  ...
  useEffect(() => {
    if (product && isOpen) {
      ...
      const parsedVariations = product.variations.map((v) => {
        ...
        // Fallback for names that don't match (e.g., "Small Pack")
        return {
          value: v.name,
          unit: "pcs",
          price: v.price,
      ...
      product.subscriptionOptions?.forEach((opt) => {
        if (opt in initialSubs)
          initialSubs[opt as keyof typeof initialSubs] = true;
      });
      setSubscriptions(initialSubs);
